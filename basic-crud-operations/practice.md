...
# Insert 2 patient with at least 1 history entry per patient

**With the next command:**

    db.patients.insertMany([ { "firstName": "John", "lastName": "Sarmiento", "age": 18, "history": [ { "disease": "Chronic Repiratory", "treatment": "Antibiotics" }] }, { "firstName": "Magnus", "lastName": "Sarmiento", "age": 13, "history": [ { "disease": "Infectious bronchitis", "treatment": "None" }] }, { "firstName": "Carlsen", "lastName": "López", "age": 29, "history": [ { "disease": "Coccidiosis", "treatment": "Sulfas" }] }]
